...
if not os.path.exists(
        '/data/zhongz2/BigData/TCGA-BRCA/splits_HistoAnno/train-{}-node-1-of-{}.csv'.format(split_num, num_nodes)):
    ...
    for i in range(num_nodes):
        dfs[i].to_csv(
            '/data/zhongz2/BigData/TCGA-BRCA/splits_HistoAnno/train-{}-node-{}-of-{}.csv'.format(split_num, i + 1,
                                                                                                 num_nodes))
